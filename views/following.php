                                ...
                                if (isset($followings)) {
                                    foreach ($followings as $user) {
                                        if (empty($user) != true) {
                                            ...
                                            echo'<lable class="mb-0 text-small text-muted font-italic"><i class = "fa fa-music mr-2"></i>' . $user->getgenres() . '</lable><br>';
                                            if (strpos($friendList, $user->getuserName()) !== false) {
                                                echo'<lable class="mb-0 text-small text-muted font-italic">Friend</lable>';
                                            }
                                            echo ' </figcaption>';
                                            echo'</figure>';
                                            echo'</div>';
